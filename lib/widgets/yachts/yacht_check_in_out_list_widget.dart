...
class YachtCheckInOutListWidget extends StatefulWidget {
  final Yacht yacht;
  ...
  @override
  State<YachtCheckInOutListWidget> createState() =>
      _YachtCheckInOutListWidgetState();
}

class _YachtCheckInOutListWidgetState extends State<YachtCheckInOutListWidget> {
  ...
  Future getCheckInsOuts() async {
    if (!dataLoaded) {
      checkInOutList = await getCheckInOuts(widget.checkIn, widget.yacht.id!);
      dataLoaded = true;
    }
                                          ...
                                          child: Center(
                                            child: InkWell(
                                              onTap: () {
                                                ...
                                                child: Text("download", style: CustomTextStyles
                                                    .textStyleTableColumn(
