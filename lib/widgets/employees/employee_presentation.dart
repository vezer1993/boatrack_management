...
import 'package:boatrack_management/widgets/employees/sub_widgets/employee_task_widget.dart';
            ...
            if (snapshot.connectionState == ConnectionState.none) {
              ...
              return Column(
                ...
                children: [
                  ...
                  MultiWidgetContainer(rightWidget: EmployeeTaskWidget(account: account,), topLeftWidget: EmployeeYachtsCleanedWidget(cleanings: cleanings), mainWidget: EmployeeCleaningList(employeeID: widget.selectedEmployee, containerHeight: 325, cleanings: cleanings,), containerHeight: 370, topRightWidget: EmployeeAverageCleaningTimeWidget(cleanings: cleanings,),)
                ],
              );
            }
          });
