...
import 'package:boatrack_management/models/issues_images.dart';
...
class DashboardUnresolvedIssueList extends StatefulWidget {
  const DashboardUnresolvedIssueList({Key? key}) : super(key: key);

  @override
  State<DashboardUnresolvedIssueList> createState() => _DashboardUnresolvedIssueListState();
}

class _DashboardUnresolvedIssueListState extends State<DashboardUnresolvedIssueList> {
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              if ((index + ((page - 1) * itemsPerPage)) <
                                ...
                                IssueItem item = data[i];
                                //Accounts employee = employees.where((element) => element.id == item.accountID).first;
                                Yacht yacht = yachts.where((element) => element.id == item.yachtId).first;
                                        ...
                                        SizedBox(
                                          ...
                                          child: Padding(
                                            padding: StaticValues
                                                .standardTableItemPadding(),
                                            child: Center(
                                                child: Text(Conversion.convertISOTimeToStandardFormatWithTime(item.timestamp.toString()),
                                                    style: CustomTextStyles
